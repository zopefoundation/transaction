...
release = get_version('transaction')
...
project = 'transaction'
copyright = f'2012-{datetime.date.today().year}, Zope Foundation Contributors'
...
latex_documents = [
    ('index', 'transaction.tex', 'transaction Documentation',
...
man_pages = [
    ('index', 'transaction', 'transaction Documentation',
